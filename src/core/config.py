...
CommandLine.add_argument('-c', '--config', type=str, action='store', help='Specify path to the configuration file', default='./config/app.cfg')
###Class definitions
...
class ConfigValue(object):
    ...
    def __init__(self, name, datatype=str, value=None, default=None):
        if datatype not in (str, int, float, complex, list, tuple, dict, bool, set, bytes):
    ...
    def _eval_value(self, value):
        if self._datatype == bool:
            ...
            _false = 0, 0.0, False, 'False','false', 'no' , 'n',
...
###Globals and Default values
    ...
    def __init__(self):
        ...
        self.debug = ConfigSection(
                ...
                ConfigPath('remote_workdir', default='./RemoteSystemsTempFiles', exists=False, create=False),
    ...
    def read(self, filename):
        ...
        try:
            ...
            self.apply_defaults()
        except (configparser.ParsingError, configparser.MissingSectionHeaderError) as ex:
            print(ex)
